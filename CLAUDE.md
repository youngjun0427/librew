...
### 브랜치 네이밍
`[prefix]/[short-desc]` — prefix는 커밋 컨벤션과 동일 (feat/fix/refactor/style/chore/docs)
...
## 세션 시작 루틴
```
전체 파악:       CLAUDE.md + _docs/context/ 전부 읽어줘
기능 개발:       CLAUDE.md + architecture.md 읽고 [기능명] 작업할게
버그 디버깅:     CLAUDE.md + conventions.md 읽고 이 에러 봐줘: [에러]
